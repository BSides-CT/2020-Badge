...
void SPI_0_PORT_init(void)
{
	...
	gpio_set_pin_direction(SPI_MISO, GPIO_DIRECTION_OUT);

	gpio_set_pin_function(SPI_MISO, PINMUX_PA22C_SERCOM1_PAD0);

	// Set pin direction to input
	gpio_set_pin_direction(SPI_MOSI, GPIO_DIRECTION_IN);

	gpio_set_pin_pull_mode(SPI_MOSI,
	                       // <y> Pull configuration
	                       // <id> pad_pull_config
	                       // <GPIO_PULL_OFF"> Off
	                       // <GPIO_PULL_UP"> Pull-up
	...
	gpio_set_pin_function(SPI_MOSI, PINMUX_PA16C_SERCOM1_PAD2);
